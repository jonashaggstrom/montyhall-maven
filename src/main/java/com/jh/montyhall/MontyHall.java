...
public class MontyHall {
	...
	//You can select the number of boxes used and how many iterations to run in config.properties
	...
	private static void printStats(Integer pFixedWins, Integer pChangeWins, Integer pLastChange) {
        ...
        System.out.println("Participant who stays with guess: " + fixedWinPercent + "% wins(" + pFixedWins + ") in " + AppConfig.iterations + " iterations of show with " + AppConfig.numberOfBoxes + " boxes" );
        System.out.println("Participant who changes every decision: " + changedWinPercent + "% wins(" + pChangeWins + ") in " + AppConfig.iterations + " iterations of show with " + AppConfig.numberOfBoxes + " boxes" );
        System.out.println("Participant who changes his last decision: " + lastMinuteChangeWinPercent + "% wins(" + pLastChange + ") in " + AppConfig.iterations + " iterations of show with " + AppConfig.numberOfBoxes + " boxes" );
	}
